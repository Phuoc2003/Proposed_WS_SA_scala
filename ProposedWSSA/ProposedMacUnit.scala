...
class ProposedMacUnit[T <: Data](inputType: T, weightType: T, cType: T, dType: T, fbType: T)() extends RawModule {
  ...
  val csaB = Wire(new Bundle { 
    val 16MulS15 = Vec(16, Bool())
    val mulS = SInt(16.W)
  }) 
  csaB.16MulS15 := VecInit.tabulate(16)(_ => mulS(15))
  csaB.mulS := mulS
